        ...
        <div v-if="type === 'personal'">
          ...
          <table cellspacing="0" width="100%" class="tableList">
            ...
            <tr>
              ...
              <th>身份证照片</th>
              <td colspan="5"><img :src="formData.iDCardPhoto"></td>
            </tr>
            <tr>
              <th>籍贯</th>
            ...
            <tr>
              <th>员工照片</th>
              <td><img :src="formData.staffPhoto" alt="" style="width: 10vw;"></td>
              <th>生日</th>
...
<script>
import { getPersonalDetail, getJobInfo } from '@/api/employees'
...
export default {
  ...
  // 创建完毕状态
  created() {
    this.type === 'personal' ? this.getPersonalDetail() : this.getJobInfo()
  },
  // 组件更新
  methods: {
